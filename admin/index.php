...
elseif($page==='api_integrations'){
 ...
 $incoming=table_exists('api_pairing_requests')?all("SELECT * FROM api_pairing_requests WHERE direction='incoming' AND ".api_ui_active_status_sql('status')." ORDER BY id DESC LIMIT 50"):[];
