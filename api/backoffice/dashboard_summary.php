...
try{$data['pending_distributions']=(int)db()->query("SELECT COUNT(*) FROM kitchen_sales_headers WHERE status IN ('draft','posted','failed_sync')")->fetchColumn();}catch(Throwable $e){}
