...
$st=db()->prepare("INSERT INTO api_pairing_requests(direction,request_code,request_secret_hash,requester_name,requester_type,requester_base_url,target_type,requested_scope,status,callback_url,expires_at,created_at,last_message) VALUES('incoming',?,?,?,?,?,?,?,'pending',?,DATE_ADD(NOW(), INTERVAL 48 HOUR),NOW(),'Menunggu approval')");
